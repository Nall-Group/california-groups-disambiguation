...
#read in data from Santa Cruz County CSV document
csvinput=read.csv("Santa Cruz County Organized.csv")
...
measurefull="Santa Cruz, Measure N, Empty Home Tax"

measure="N"

yescolumn="MEASURE.N.Yes"  
nocolumn="MEASURE.N.No"  
#---------------------------------------------------EACH SECTION IS DIFFERENT MEASURE----------------------------------------------------------------#
#choose measure to analyze, save name, shorthand, and column names

measurefull="Santa Cruz, Measure O,\nGeneral Plan and Downtown Plan Amendment"
...
measurefull="Santa Cruz, Measure P, Transient Occupancy Tax"

measure="P"

yescolumn="MEASURE.P.Yes"          
nocolumn="MEASURE.P.No"          
#---------------------------------------------------EACH SECTION IS DIFFERENT MEASURE----------------------------------------------------------------#
#choose measure to analyze, save name, shorthand, and column names

measurefull="Watsonville, Measure Q,\nPlanned Growth and Farmland Protection"

measure="Q"

yescolumn="MEASURE.Q.Yes"               
nocolumn="MEASURE.Q.No"               
#---------------------------------------------------EACH SECTION IS DIFFERENT MEASURE----------------------------------------------------------------#
#choose measure to analyze, save name, shorthand, and column names

measurefull="Watsonville, Measure S, Planning for Watsonville's Future"

measure="S"

yescolumn="MEASURE.S.Yes"
nocolumn="MEASURE.S.No"
#---------------------------------------------------EACH SECTION IS DIFFERENT MEASURE----------------------------------------------------------------#
...
setwd("/Users/davidlitman/Library/CloudStorage/Dropbox/niskanen/figs/Santa Cruz County-Linear Regression on Measures")

#automize file name
png(paste("Santa Cruz County Measure ",measure," Plot.png",sep=""))
...
plot(DATA$yvar~DATA$xvar, pch=19, xlim=c(0,1), ylim=c(0,1),
     main = measurefull,
     sub="Santa Cruz County Precinct by Precinct Scatterplot and Best Fit Line", 
...
setwd("/Users/davidlitman/Library/CloudStorage/Dropbox/niskanen/figs/Santa Cruz County-Linear Regression on Measures/Plot Statistics")
sink(paste("Santa Cruz County Measure ",measure," Plot Statistics.txt",sep=""))
