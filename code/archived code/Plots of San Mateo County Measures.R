...
#read in data from San Mateo County CSV document
csvinput=read.csv("San Mateo County Organized.csv")
...
measurefull="South San Francisco, Measure AA, Affordable Housing Authorization"

measure="AA"

yescolumn="City.of.South.San.Francisco..Measure.AA..Majority.Approval.Required..YES"
nocolumn="City.of.South.San.Francisco..Measure.AA..Majority.Approval.Required..NO"
#---------------------------------------------------EACH SECTION IS DIFFERENT MEASURE----------------------------------------------------------------#
#choose measure to analyze, save name, shorthand, and column names

measurefull="Menlo Park, Measure V, Zoning Initiative"

measure="V"

yescolumn="City.of.Menlo.Park..Measure.V..Majority.Approval.Required..YES"  
nocolumn="City.of.Menlo.Park..Measure.V..Majority.Approval.Required..NO"  
#---------------------------------------------------EACH SECTION IS DIFFERENT MEASURE----------------------------------------------------------------#
...
setwd("/Users/davidlitman/Library/CloudStorage/Dropbox/niskanen/figs/San Mateo County-Linear Regression on Measures")

#automize file name
png(paste("San Mateo County Measure ",measure," Plot.png",sep=""))
...
plot(DATA$yvar~DATA$xvar, pch=19, xlim=c(0,1), ylim=c(0,1),
     main = measurefull,
     sub="San Mateo County Precinct by Precinct Scatterplot and Best Fit Line", 
...
setwd("/Users/davidlitman/Library/CloudStorage/Dropbox/niskanen/figs/San Mateo County-Linear Regression on Measures/Plot Statistics")
sink(paste("San Mateo County Measure ",measure," Plot Statistics.txt",sep=""))
