...
#read in data from Stanislaus County CSV document
csvinput=read.csv("Stanislaus County Organized.csv")
...
measurefull="Modesto, Measure H, General Sales Tax"

measure="H"

yescolumn="City.of.Modesto.Measure.H.YES" 
nocolumn="City.of.Modesto.Measure.H.NO" 
...
setwd("/Users/davidlitman/Library/CloudStorage/Dropbox/niskanen/figs/Stanislaus County-Linear Regression on Measures")

#automize file name
png(paste("Stanislaus County Measure ",measure," Plot.png",sep=""))
...
plot(DATA$yvar~DATA$xvar, pch=19, xlim=c(0,1), ylim=c(0,1),
     main = measurefull,
     sub="Stanislaus County Precinct by Precinct Scatterplot and Best Fit Line", 
...
setwd("/Users/davidlitman/Library/CloudStorage/Dropbox/niskanen/figs/Stanislaus County-Linear Regression on Measures/Plot Statistics")
sink(paste("Stanislaus County Measure ",measure," Plot Statistics.txt",sep=""))
