...
#read in data from Fresno County CSV document
csvinput=read.csv("Fresno County Organized.csv")
...
measurefull="Fresno, Measure M, Sales Tax for Veteran Support"

measure="M"

yescolumn="M..City.of.Fresno...Veterans.Support.Measure.YES"
nocolumn="M..City.of.Fresno...Veterans.Support.Measure.NO"
#---------------------------------------------------EACH SECTION IS DIFFERENT MEASURE----------------------------------------------------------------#
...
setwd("/Users/davidlitman/Library/CloudStorage/Dropbox/niskanen/figs/Fresno County-Linear Regression on Measures")

#automize file name
png(paste("Fresno County Measure ",measure," Plot.png",sep=""))
...
plot(DATA$yvar~DATA$xvar, pch=19, xlim=c(0,1), ylim=c(0,1),
     main = measurefull,
     sub="Fresno County Precinct by Precinct Scatterplot and Best Fit Line", 
...
setwd("/Users/davidlitman/Library/CloudStorage/Dropbox/niskanen/figs/Fresno County-Linear Regression on Measures/Plot Statistics")
sink(paste("Fresno County Measure ",measure," Plot Statistics.txt",sep=""))
