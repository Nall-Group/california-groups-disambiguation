...
#read in data from San Benito County CSV document
csvinput=read.csv("San Benito County Organized.csv")
...
measurefull="San Benito County, Measure Q,\n Require Vote for Certain Land Use Changes"
...
setwd("/Users/davidlitman/Library/CloudStorage/Dropbox/niskanen/figs/San Benito County-Linear Regression on Measures")

#automize file name
png(paste("San Benito County Measure ",measure," Plot.png",sep=""))
...
plot(DATA$yvar~DATA$xvar, pch=19, xlim=c(0,1), ylim=c(0,1),
     main = measurefull,
     sub="San Benito County Precinct by Precinct Scatterplot and Best Fit Line", 
...
setwd("/Users/davidlitman/Library/CloudStorage/Dropbox/niskanen/figs/San Benito County-Linear Regression on Measures/Plot Statistics")
sink(paste("San Benito County Measure ",measure," Plot Statistics.txt",sep=""))
