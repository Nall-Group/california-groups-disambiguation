...
#read in data from Solano County CSV document
csvinput=read.csv("Solano County Organized.csv")
...
measurefull="Benicia, Measure K, Urban Growth Boundary Extension
"
measure="K"

yescolumn="CITY.OF.BENICIA.MEASURE.K.YES" 
nocolumn="CITY.OF.BENICIA.MEASURE.K.NO"
#---------------------------------------------------EACH SECTION IS DIFFERENT MEASURE----------------------------------------------------------------#
...
setwd("/Users/davidlitman/Library/CloudStorage/Dropbox/niskanen/figs/Solano County-Linear Regression on Measures")

#automize file name
png(paste("Solano County Measure ",measure," Plot.png",sep=""))
...
plot(DATA$yvar~DATA$xvar, pch=19, xlim=c(0,1), ylim=c(0,1),
     main = measurefull,
     sub="Solano County Precinct by Precinct Scatterplot and Best Fit Line", 
...
setwd("/Users/davidlitman/Library/CloudStorage/Dropbox/niskanen/figs/Solano County-Linear Regression on Measures/Plot Statistics")
sink(paste("Solano County Measure ",measure," Plot Statistics.txt",sep=""))
