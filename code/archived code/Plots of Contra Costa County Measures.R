...
#read in data from Contra Costa County CSV document
csvinput=read.csv("Contra Costa County Organized.csv")
...
measurefull="Richmond, Measure P, Rent-Control Increase"

measure="P"

yescolumn="MEASURE.P...CITY.OF.RICHMOND.YES."
nocolumn="MEASURE.P...CITY.OF.RICHMOND.NO."
#---------------------------------------------------EACH SECTION IS DIFFERENT MEASURE----------------------------------------------------------------#
...
setwd("/Users/davidlitman/Library/CloudStorage/Dropbox/niskanen/figs/Contra Costa County-Linear Regression on Measures")

#automize file name
png(paste("Contra Costa County Measure ",measure," Plot.png",sep=""))
...
plot(DATA$yvar~DATA$xvar, pch=19, xlim=c(0,1), ylim=c(0,1),
     main = measurefull,
     sub="Contra Costa County Precinct by Precinct Scatterplot and Best Fit Line", 
...
setwd("/Users/davidlitman/Library/CloudStorage/Dropbox/niskanen/figs/Contra Costa County-Linear Regression on Measures/Plot Statistics")
sink(paste("Contra Costa County Measure ",measure," Plot Statistics.txt",sep=""))
