...
#read in data from San Bernardinoo County CSV document
csvinput=read.csv("San Bernardino County Organized.csv")
...
measurefull="Redlands, Measure F, Socio-Economic Analyses and Land Usage"

measure="F"

yescolumn="City.of.Redlands.MEASURE.F.YES." 
nocolumn="City.of.Redlands.MEASURE.F.NO."
#---------------------------------------------------EACH SECTION IS DIFFERENT MEASURE----------------------------------------------------------------#
...
setwd("/Users/davidlitman/Library/CloudStorage/Dropbox/niskanen/figs/San Bernardino County-Linear Regression on Measures")

#automize file name
png(paste("San Bernardino County Measure ",measure," Plot.png",sep=""))
...
plot(DATA$yvar~DATA$xvar, pch=19, xlim=c(0,1), ylim=c(0,1),
     main = measurefull,
     sub="San Bernardino County Precinct by Precinct Scatterplot and Best Fit Line", 
...
setwd("/Users/davidlitman/Library/CloudStorage/Dropbox/niskanen/figs/San Bernardino County-Linear Regression on Measures/Plot Statistics")
sink(paste("San Bernardino County Measure ",measure," Plot Statistics.txt",sep=""))
